...
export type PromiseArray = Unpromisify<ReturnType<typeof getBooksByCategoryPromise>>;
export type PromiseItem = UnArray<Unpromisify<ReturnType<typeof getBooksByCategoryPromise>>>;
